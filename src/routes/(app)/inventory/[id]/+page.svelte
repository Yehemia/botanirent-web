...
<div class="mx-auto max-w-4xl space-y-6 pb-12">
	...
	<div class="flex items-center gap-4">
		...
		<div>
			<h1 class="font-heading text-3xl font-bold text-[var(--color-earth)]">Edit Barang</h1>
			<p class="mt-1 text-[var(--color-stone)]">
				Barcode: <span
					class="rounded-md bg-[var(--color-sand)] px-2 py-0.5 font-mono font-bold text-[var(--color-earth)]"
					>{item.barcode || '-'}</span
				>
			</p>
		</div>
